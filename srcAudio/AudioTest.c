...
void AudioTest_setFreq1(AudioTest *audiotest, uint _freq1) { if ((audiotest->audio.play)&&(audiotest->audio.initialized)) SDL_LockAudio(); freq1 = _freq1; bytesPerPeriod1 = sampleFrequency / _freq1; if ((audiotest->audio.play)&&(audiotest->audio.initialized)) SDL_UnlockAudio(); audiotest->freq1 = _freq1; }
void AudioTest_setFreq2(AudioTest *audiotest, uint _freq2) { if ((audiotest->audio.play)&&(audiotest->audio.initialized)) SDL_LockAudio(); freq2 = _freq2; bytesPerPeriod2 = sampleFrequency / _freq2; if ((audiotest->audio.play)&&(audiotest->audio.initialized)) SDL_UnlockAudio(); audiotest->freq2 = _freq2; }
void AudioTest_setFase1(AudioTest *audiotest, uint _fase1) { if ((audiotest->audio.play)&&(audiotest->audio.initialized)) SDL_LockAudio(); fase1 = _fase1; if ((audiotest->audio.play)&&(audiotest->audio.initialized)) SDL_UnlockAudio(); audiotest->fase1 = _fase1; }
void AudioTest_setFase2(AudioTest *audiotest, uint _fase2) { if ((audiotest->audio.play)&&(audiotest->audio.initialized)) SDL_LockAudio(); fase2 = _fase2; if ((audiotest->audio.play)&&(audiotest->audio.initialized)) SDL_UnlockAudio(); audiotest->fase2 = _fase2; }
