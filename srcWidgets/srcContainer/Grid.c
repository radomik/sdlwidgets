...
void Grid_dragItems(Grid *grid, signed short dx, signed short dy) {
...
static void Grid_destroy_common(Grid *this, const char *fname) {
...
static void Grid_new_common(Grid *this, usint c_row, usint c_col, const char *fname) {
	if (VERBOSE_CREATE)
...
void Grid_setVisible(Grid *grid, bool vis) { 
