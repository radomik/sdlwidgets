...
void FloatingMenu_refresh(FloatingMenu *this) { StackList_refresh((StackList*)this); }
...
//~ void FloatingMenu_setHeaderFont(FloatingMenu *this, TTF_Font *font) { this->font_header = font; }
//~ void FloatingMenu_setButtonFont(FloatingMenu *this, TTF_Font *font) { this->font_button = font; }
//~ void FloatingMenu_setLabelFont(FloatingMenu  *this, TTF_Font *font) { this->font_label  = font; }
...
void FloatingMenu_setVisible(FloatingMenu *this, bool vis) { StackList_setVisible((StackList*)this, vis); }
