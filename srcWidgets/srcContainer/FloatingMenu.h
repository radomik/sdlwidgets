 ...
 */
	...
	void FloatingMenu_refresh(FloatingMenu *this);
	
	//~ void FloatingMenu_setHeaderFont(FloatingMenu *this, TTF_Font *font);
	//~ void FloatingMenu_setButtonFont(FloatingMenu *this, TTF_Font *font);
	//~ void FloatingMenu_setLabelFont(FloatingMenu  *this, TTF_Font *font);
	...
	void FloatingMenu_setVisible(FloatingMenu *this, bool vis);
#endif
