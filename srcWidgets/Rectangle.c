...
void Rectangle_setColor(Rectangle *rectangle, uint rgb_color) { rectangle->color = rgb_color; }

// sets only size of rectangle widget
void Rectangle_setSize(Rectangle *rectangle, usint width, usint height) 
	{ Widget_setSize((Widget*)rectangle, width, height); }

// Sets only position of rectangle widget
void Rectangle_setPosition(Rectangle *rectangle, usint minx, usint miny) 
	{ Widget_setPosition((Widget*)rectangle, minx, miny); }

void Rectangle_getCenter(Rectangle *rectangle, usint *cx, usint *cy) 
	{ Widget_getCenter((Widget*)rectangle, cx, cy); }
void Rectangle_setCenter(Rectangle *rectangle, usint cx, usint cy) 
	{  Widget_setCenter((Widget*)rectangle, cx, cy); }

bool Rectangle_contains(Rectangle *rectangle, usint x, usint y) 
	{ return Widget_contains((Widget*)rectangle, x, y); }

// Sets position and width and height
void Rectangle_setRect(Rectangle *rectangle, usint minx, usint miny, usint width, usint height) 
	{ Widget_setRect((Widget*)rectangle, minx, miny, width, height); }

void Rectangle_scale(Rectangle *rectangle, double xscale, double yscale, int smooth)
