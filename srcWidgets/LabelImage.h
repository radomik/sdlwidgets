 ...
 */
	...
	void LabelImage_scale(LabelImage *labelimage, double xscale, double yscale, int smooth);
	
	// Need to call LabeImage_refresh after all of that functions
	void LabelImage_setBorder(LabelImage *labelimage, usint bord_width, uint rgb);
	void LabelImage_setPadding(LabelImage *labelimage, usint padx, usint pady);
	void LabelImage_setBgColor(LabelImage *labelimage, uint rgb);
