...
#include "../srcCommon/MemoryUsage.h"
#include "../srcCommon/Screen.h"
#include "../srcCommon/Static.h"
#include "../srcCommon/Object.h"
#include "../srcCommon/Memory.h"
#include "../srcGraphics/Histogram.h"
#include "../srcGraphics/HistStretchGraph.h"
#include "../srcGraphics/PixelDrawBox.h"
#include "../srcAudio/WaveDrawBox.h"
#include "Widget.h"
#include "Image.h"
#include "Button.h"
#include "TextBlock.h"
...
#include "Rectangle.h"
#include "srcContainer/Container.h"
#include <string.h>
...
static void Widget_destroy_common(Widget *this, const char *fname) {
...
void Widget_copy_common(Widget *widget_dest, Widget *widget_src) {
...
void Widget_std_init(Widget *widget) {
...
bool Widget_contains(Widget *widget, usint x, usint y) { 
	return (widget) 
