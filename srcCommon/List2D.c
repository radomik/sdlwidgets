...
void List2D_seekCurrentToFirst(List2D *list2d) { list2d->current = list2d->first; }

void List2D_seekCurrentToLast(List2D *list2d) { list2d->current = list2d->last; }
...
ullong List2D_getCount(List2D *list2d) { return list2d->count; }
bool List2D_isEmpty(List2D *list2d) { return ! list2d->first; }
