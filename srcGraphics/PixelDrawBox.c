...
void PixelDrawBox_setPosition(PixelDrawBox *pdb, usint minx, usint miny) {
	Widget_setPosition((Widget*)pdb, minx, miny);
}

void PixelDrawBox_setPadding(PixelDrawBox *pdb, usint padx, usint pady) { 
...
void PixelDrawBox_increaseActX(PixelDrawBox *pdb, usint dx) { 
...
void PixelDrawBox_increaseActY(PixelDrawBox *pdb, usint dy) { 
...
void PixelDrawBox_decreaseActX(PixelDrawBox *pdb, usint dx) { 
	if (pdb->actX > 1) { 
...
void PixelDrawBox_decreaseActY(PixelDrawBox *pdb, usint dy) { 
	if (pdb->actY > 1) { 
...
void PixelDrawBox_setEnabled(PixelDrawBox *pdb, bool sel) {
	pdb->enabled = sel; 
	// add some code here
}
